  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        theme_color: '#2A1D12',
        icons: [
          { src: '/icons/icon-48.png?v=4', sizes: '48x48', type: 'image/png' },
          { src: '/icons/icon-72.png?v=4', sizes: '72x72', type: 'image/png' },
          { src: '/icons/icon-96.png?v=4', sizes: '96x96', type: 'image/png' },
          { src: '/icons/icon-128.png?v=4', sizes: '128x128', type: 'image/png' },
          { src: '/icons/icon-144.png?v=4', sizes: '144x144', type: 'image/png' },
          { src: '/icons/icon-152.png?v=4', sizes: '152x152', type: 'image/png' },
          { src: '/icons/icon-192.png?v=4', sizes: '192x192', type: 'image/png', purpose: 'any' },
          { src: '/icons/icon-384.png?v=4', sizes: '384x384', type: 'image/png' },
